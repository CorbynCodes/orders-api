...
import (
	...
	"github.com/CorbynCodes/orders-api/model"
	"github.com/CorbynCodes/orders-api/repository/order"
...
func (h *Order) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Errorf("failed to insert:", err)
...
func (h *Order) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	if errors.Is(err, order.ErrorNotExist) {
		...
		fmt.Print("failed to find by id:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	if err := json.NewEncoder(w).Encode(o); err != nil {
		fmt.Print("failed by marshal:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (h *Order) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Print("failed to update:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
